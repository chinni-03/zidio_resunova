...
export default function AwardDetails() {
    const {handleOnChange, awardData} = useAward();
                ...
                <div className="form">
                    {addmoreaward.map((details, index) => (
                        <div key={index}>
                            ...
                            {index > 0 && (
                                <button type="button" className="w-100" onClick={() => deleteSection(index)}>
                    ...
                    <div className="btns">
                        <Link className="w-50" to={`/project-details/${resumeType}`}>
